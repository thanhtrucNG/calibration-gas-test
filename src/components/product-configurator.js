...
export function createProductConfigurator(families, taxonomy, catalogue, mapping, cart, announce, checkout) {
  ...
  const CONFIG_STATE_KEY = 'calibration-gas.configurator-state.v1';
  let session;
  ...
  const title = element('h2', '', t('ORDER'));
  ...
  const labels = { config_concept: 'Choose a mixture', product_family_id: 'Choose a design', dimensions_display: 'Choose cylinder size', edition: 'Cylinder basis' };
