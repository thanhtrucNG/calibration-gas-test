...
import { productCode, productCylinder } from '../lib/product-profile.js';
...
export function createEditionPurchase({ number, catalogue, cart, announce, onSelect, getState }) {
  ...
  legend.append(element('span', 'step-number', String(number)), element('span', '', t('Cylinder basis')));
  ...
  function update(state) {
    ...
    impa.textContent = productCylinder(current);
